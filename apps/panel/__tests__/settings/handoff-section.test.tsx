...
import { HandoffSection } from '@/pages/settings/handoff-section'
...
const mockTenant = {
  ...
  handoffRules: { score_threshold: 60, max_ai_turns: 15, business_hours_only: false, handoff_intents: ['complaint'], auto_handoff_on_price: false, follow_up_enabled: false, follow_up_delay_hours: 24 },
  quickReplies: [], billingStatus: 'trial' as const, trialEndsAt: null,
  createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(),
}

describe('HandoffSection', () => {
  it('renders handoff rule controls', () => {
    renderWithProviders(<HandoffSection tenant={mockTenant} />)
