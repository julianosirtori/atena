      ...
      <div className="flex flex-col h-[60vh]">
        ...
        <div className="flex items-end gap-2 border-t border-warm-100 p-4">
          ...
          <textarea
            ...
            rows={1}
            className="flex-1 resize-none overflow-hidden rounded-lg border border-warm-200 bg-warm-50 px-3 py-2 text-sm text-warm-900 placeholder:text-warm-400 focus:border-amber-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-500/20"
          />
          <Button
            size="icon"
            onClick={handleSend}
